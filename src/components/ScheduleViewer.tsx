...
export const ScheduleViewer: React.FC<ScheduleViewerProps> = ({ 
  ...
  return (
    <div className="bg-white dark:bg-black rounded-2xl shadow-2xl border border-slate-200 dark:border-zinc-900 overflow-hidden">
      ...
      {scenarios.length > 0 && (
        <div data-html2canvas-ignore="true" className="flex items-center gap-1.5 px-3 sm:px-6 py-2 bg-slate-100/80 dark:bg-zinc-950 border-b border-slate-200 dark:border-zinc-900 overflow-x-auto scrollbar-none">
