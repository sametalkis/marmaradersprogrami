  ...
  return (
    <div 
      className={`
        ...
        ${course.isSelected ? 'ring-2 ring-indigo-500 border-indigo-300 dark:border-indigo-700' : ''}
      `}
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1 text-[11px] text-slate-500 dark:text-zinc-400">
            ...
            {schedules.length > 1 && (
              <span className="text-indigo-600 dark:text-indigo-400 font-semibold">+{schedules.length - 1}</span>
            )}
          </div>
        </div>
              ...
              <button
                ...
                className={`relative flex items-center justify-center rounded-lg transition-all active:scale-95 ${
                  course.tag
                    ...
                    : showTagDropdown
                    ? 'p-2 bg-indigo-50 dark:bg-zinc-800 text-indigo-600 dark:text-indigo-400 ring-2 ring-indigo-500/30 rounded-lg'
                        ...
                        return (
                          <button
                            ...
                            className={`flex items-center gap-1.5 px-2.5 py-2 rounded-xl text-xs font-semibold transition-all border text-left relative ${
                              isSelected
                                ? 'bg-indigo-50 dark:bg-zinc-800 border-indigo-300 dark:border-indigo-500/60 text-indigo-900 dark:text-white shadow-xs'
                          ...
                          >
                            ...
                            {isSelected && <span className="ml-auto text-indigo-600 dark:text-indigo-400 text-[10px] font-bold">✓</span>}
                          </button>
                        );
                      })}
                    </div>
                        ...
                        {customTags.map((tag) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {isSelected && <span className="text-indigo-600 dark:text-indigo-400 text-[10px] font-bold">✓</span>}
                            </button>
                          );
                        })}
                      </div>
